            ...
            <div className="bg-white rounded-2xl border border-emerald-200 p-6 shadow-sm space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <p className="text-sm text-slate-500">total kcal</p>
                </div>
              </div>
                    ...
                    {result.foods.map((food, idx) => (
                      <div key={idx} className="flex items-center justify-between p-3 bg-slate-50 rounded-xl">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="font-medium text-slate-900 text-sm capitalize">{food.name}</p>
                            <p className="text-xs text-slate-500">
                              {food.weightG}g · P: {food.proteinG?.toFixed(1)}g · C: {food.carbsG?.toFixed(1)}g · F: {food.fatG?.toFixed(1)}g
                            </p>
                          </div>
                        </div>
