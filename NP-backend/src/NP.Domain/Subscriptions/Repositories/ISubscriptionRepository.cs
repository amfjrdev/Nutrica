...
public interface ISubscriptionRepository : IRepository<Subscription>
{
    ...
    Task<Subscription?> GetActiveByClientIdAndTypeAsync(Guid clientId, SubscriptionType type, CancellationToken cancellationToken = default);
    Task<Subscription?> GetPendingByClientIdAsync(Guid clientId, CancellationToken cancellationToken = default);
    Task<Subscription?> GetPendingByClientIdAndTypeAsync(Guid clientId, SubscriptionType type, CancellationToken cancellationToken = default);
